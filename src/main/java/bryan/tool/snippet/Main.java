...
class RedBlackTree<T extends Comparable<T>> {
    ...
    /**
     * @param y The node which the rightRotate is to be performed on.
...
class TestRBT {
    public static void main(String[] args) {
        ...
        integerRedBlackTree.insert(2);
        integerRedBlackTree.insert(7);
        integerRedBlackTree.insert(5);
        integerRedBlackTree.insert(4);
        integerRedBlackTree.insert(3);
        integerRedBlackTree.insert(21);
        integerRedBlackTree.insert(50);
        integerRedBlackTree.insert(41);
        integerRedBlackTree.insert(24);
        integerRedBlackTree.insert(9);
        integerRedBlackTree.insert(0);

        assert integerRedBlackTree.search(24) != null;
    }
}